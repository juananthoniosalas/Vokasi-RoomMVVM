...
class NewStudentViewModel(application: Application) : AndroidViewModel(application) {
    ...
    //function storeMovie berfungsi untuk melakukan penambahan data pada database
    ...
    //function retrieveStudent berfungsi untuk melakukan penerimaan semua data pada database
